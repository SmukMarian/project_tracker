...
## Next steps
1. Покрыть сборку инсталлятора (PyInstaller + NSIS) и запуск desktop-обёртки автоматическими smoke-тестами.
2. Автоматизировать проверку автообновления десктопа против хостируемого манифеста и загружаемого пакета.
