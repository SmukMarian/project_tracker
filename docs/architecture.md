...
## Next steps
1. Подключить медиатеку/аттачменты к workspace и реализовать диалоги импорта/выбора файлов.
2. Дополнить desktop-обёртку (автообновления, логирование) и упаковать сборку в инсталлятор.
