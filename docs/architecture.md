...
## Next steps
1. Расширить SPA до полноценных CRUD-диалогов для категорий/проектов/шагов с записью в backend (без мок-фолбэков).
2. Подключить медиатеку/аттачменты к workspace и реализовать диалоги импорта/выбора файлов.
3. Дополнить desktop-обёртку (автообновления, логирование) и упаковать сборку в инсталлятор.
