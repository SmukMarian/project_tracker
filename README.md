...
## Текущий статус
- Основные требования ТЗ покрыты; готовность оценивается примерно в 90% с учётом оставшихся задач по медиатеке и упаковке desktop-версии.
...
## Что дальше
- Добавить полноценные диалоги CRUD для категорий, проектов и шагов (модалки/формы) и синхронизировать их с backend без отката к мок-данным.
- Подключить реальную медиатеку/вложения к workspace и диалоги импорта файлов.
