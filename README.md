...
## Текущий статус
- Основные требования ТЗ покрыты; готовность оценивается примерно в 97–98%: есть диалоги CRUD, KPI/экспорты, тёмная тема и медиатека с загрузкой файлов в workspace, остаются задачи по упаковке desktop-версии (инсталлятор, автообновления, логирование).
